...
int main(void) {
	...
	*/
	...
	MJ.addMap(Map({
		...
		{MUR,	VIDE,	VIDE,	VIDE,	VIDE,	VIDE,			VIDE,	VIDE,			VIDE,	VIDE,			VIDE,	VIDE,	VIDE,	VIDE,	VIDE,	VIDE,	VIDE,	VIDE,	VIDE,	VIDE,	VIDE,		MUR},

		{MUR,	VIDE,	VIDE,	VIDE,	VIDE,	VIDE,			VIDE,	VIDE,			VIDE,	VIDE,			VIDE,	VIDE,	VIDE,	VIDE,	VIDE,	VIDE,	VIDE,	VIDE,	VIDE,	GOAL,	VIDE,		MUR},

		{MUR,	VIDE,	VIDE,	VIDE,	VIDE,	VIDE,			VIDE,	VIDE,			VIDE,	VIDE,			VIDE,	VIDE,	VIDE,	VIDE,	VIDE,	VIDE,	VIDE,	VIDE,	VIDE,	VIDE,	VIDE,		MUR},
			
		{MUR,	VIDE,	VIDE,	VIDE,	VIDE,	ROCHER,			VIDE,	VIDE,			VIDE,	VIDE,			VIDE,	VIDE,	VIDE,	VIDE,	VIDE,	VIDE,	VIDE,	VIDE,	VIDE,	VIDE,	VIDE,		MUR},

		{MUR,	VIDE,	VIDE,	VIDE,	VIDE,	VIDE,			VIDE,	VIDE,			VIDE,	VIDE,			VIDE,	VIDE,	VIDE,	VIDE,	VIDE,	VIDE,	VIDE,	VIDE,	VIDE,	VIDE,	VIDE,		MUR},

		{MUR,	VIDE,	VIDE,	VIDE,	VIDE,	VIDE,			VIDE,	VIDE,			VIDE,	VIDE,			VIDE,	VIDE,	VIDE,	VIDE,	VIDE,	VIDE,	VIDE,	VIDE,	VIDE,	VIDE,	VIDE,		MUR},

		{MUR,	VIDE,	VIDE,	VIDE,	VIDE,	BLOC_VIVANT,	VIDE,	BLOC_COULEUR3,	VIDE,	VIDE,			VIDE,	VIDE,	VIDE,	VIDE,	VIDE,	VIDE,	VIDE,	VIDE,	VIDE,	VIDE,	VIDE,		MUR},

		{MUR,	VIDE,	VIDE,	VIDE,	VIDE,	VIDE,			VIDE,	VIDE,			VIDE,	VIDE,			VIDE,	VIDE,	VIDE,	VIDE,	VIDE,	VIDE,	VIDE,	VIDE,	VIDE,	VIDE,	VIDE,		MUR},

		{MUR,	SPAWN,	VIDE,	VIDE,	VIDE,	VIDE,			VIDE,	VIDE,			VIDE,	VIDE,			VIDE,	VIDE,	VIDE,	VIDE,	VIDE,	VIDE,	VIDE,	VIDE,	VIDE,	VIDE,	VIDE,		MUR},

		{MUR,	VIDE,	VIDE,	VIDE,	VIDE,	BLOC,			VIDE,	BLOC_COULEUR2,	VIDE,	BLOC_COULEUR1,	VIDE,	VIDE,	VIDE,	VIDE,	VIDE,	VIDE,	SWITCH,	VIDE,	VIDE,	VIDE,	BOUTEILLE,	MUR},
	...
	MJ.addMap(Map({
		...
		{MUR,	MUR,	VIDE,	VIDE,			VIDE,	VIDE,		VIDE,			VIDE,			VIDE,	VIDE,			MUR,	VIDE,				VIDE,			VIDE,			VIDE,			BOUTEILLE,			VIDE,	VIDE,	VIDE,		 	BOUTEILLE_COULEUR3,	VIDE,			VIDE,	VIDE,	MUR,	VIDE,	VIDE,	VIDE,	VIDE,	VIDE,	VIDE,	MUR,	MUR},

		{MUR,	MUR,	VIDE,	VIDE,			VIDE,	VIDE,		VIDE,			ONEWAY_HAUT,	VIDE,	VIDE,			MUR,	ONEWAY_HAUT,		ONEWAY_HAUT,	ONEWAY_HAUT,	ONEWAY_HAUT,	ONEWAY_HAUT,		VIDE,	VIDE,	ONEWAY_HAUT,	ONEWAY_HAUT,		VIDE,			VIDE,	VIDE,	MUR,	VIDE,	VIDE,	VIDE,	GOAL,	VIDE,	VIDE,	MUR,	MUR},
