...
int main(void) {
	...
	*/
	...
	{MUR,	MUR,	VIDE,	GOAL,			VIDE,	VIDE,		VIDE,			VIDE,			VIDE,	VIDE,			VIDE,	VIDE,				VIDE,			VIDE,			VIDE,			VIDE,				VIDE,	VIDE,	VIDE,			VIDE,				VIDE,			VIDE,	VIDE,	MUR,	VIDE,	VIDE,	VIDE,	VIDE,	VIDE,	VIDE,	MUR,	MUR},
	...
	{MUR,	MUR,	VIDE,	VIDE,			VIDE,	VIDE,		VIDE,			ONEWAY_HAUT,	VIDE,	VIDE,			MUR,	ONEWAY_HAUT,		ONEWAY_HAUT,	ONEWAY_HAUT,	ONEWAY_HAUT,	ONEWAY_HAUT,		VIDE,	VIDE,	ONEWAY_HAUT,	ONEWAY_HAUT,		VIDE,			VIDE,	VIDE,	MUR,	VIDE,	VIDE,	GOAL,	GOAL,	GOAL,	VIDE,	MUR,	MUR},
